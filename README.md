Circuit design to show the concept of how the temperature data read by the sensor is passed on to the vest in order to produce heat in the vest if the corebody temperature is low. 
